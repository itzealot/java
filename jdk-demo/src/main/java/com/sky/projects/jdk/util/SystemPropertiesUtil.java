...
public class SystemPropertiesUtil {
	...
	public static synchronized void registerSystemPropertiesListener(PropertiesListener listener) {
		...
		((ListenableProperties) currentProperties).attach(listener);
	}
	 ...
	 * 因此扩展了一个ListenableProperties, 在其所关心的属性变化时进行通知.
	 * 
	 * @see PropertiesListenerFactory
	 */
	public static class ListenableProperties extends Properties implements PropertiesListenerFactory {
