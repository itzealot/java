package com.sky.projects.jdk.other;
...
public final class CodeUtil {
	...
	public static String generateMachineCode(String orgCode, Long id) {
		...
		return nodeCode + NODE_SEPARATOR + MACHINE_SEPARATOR + CODE_SEPARATOR + machineId;
	}
	...
	public static String generateServiceCode(String orgCode, Long id) {
		...
		return nodeCode + NODE_SEPARATOR + SERVICE_SEPARATOR + CODE_SEPARATOR + serviceId;
	}
