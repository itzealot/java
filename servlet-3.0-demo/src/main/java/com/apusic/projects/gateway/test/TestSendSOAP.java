package com.apusic.projects.gateway.test;
...
public class TestSendSOAP {
	...
	public static String getSOAP() {
		...
		buffer.append(
				"<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.ws.gateway.projects.apusic.com/\">");
	...
	public void testGetSOAP() {
		...
		try {
			...
			HttpPost post = new HttpPost("http://localhost:9090/spring-ws-web/userService?wsdl");
