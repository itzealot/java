...
public class CodeUtilTest {
	...
	public void generateNodeCode() {
		assertTrue("node code not equal", CodeUtil.generateNodeCode(orgCode).equals("100001-N"));
	}
	...
	public void getOrgCodeFrom() {
		...
		assertTrue("org code not equal", "".equals(CodeUtil.getOrgCodeFrom("Q1000100001")));
