...
import com.zt.projects.sky.util.MapUtil;
...
public class TestMapUtil {
	...
	public void testIsValidateMap() {
		String str = MapUtil.isValidateMap(map) ? "It's validate" : "It's not validate";
		System.out.println(str);
	}

	@Test
	public void testIsValidateKey() {
		System.out.println("3 is key: " + MapUtil.isValidateKey(map, new Integer(3)));
		System.out.println("7 is key: " + MapUtil.isValidateKey(map, new Integer(7)));
	}
