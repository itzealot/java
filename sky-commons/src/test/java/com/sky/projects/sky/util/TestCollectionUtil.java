...
import com.zt.projects.sky.util.CollectionUtil;
...
public class TestCollectionUtil {
	...
	public void testGetStringFromCollection() {
		System.out.println(CollectionUtil.getStringFromCollection(collection, ", ", false));

		System.out.println(CollectionUtil.getStringFromCollection(collection2, ", ", false));
