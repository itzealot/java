...
public class Dates {
	...
	public static String formatDateMostPrecise(java.util.Date date) {
		return date != null ? new SimpleDateFormat(MOST_PRECISE_FORMAT).format(date) : "";
	}
	...
	public static String formatPrecise(java.util.Date date) {
		return date != null ? new SimpleDateFormat(PRECISE_FORMAT).format(date) : "";
	}

	public static Date parseDate(String s) throws ParseException {
		return StringUtils.isNotBlank(s) ? new SimpleDateFormat(PRECISE_FORMAT).parse(s) : null;
	}

	public static Date parse(String s) throws ParseException {
		return StringUtils.isNotBlank(s) ? new SimpleDateFormat(STANDARD_FORMAT).parse(s) : null;
	}
	...
	/**
	 * 获取[start,end]之间的所有日期 如果start == null && end != null,则返回end 如果start !=
	 * null && end == null,则返回[start,yesterday]之间的所有日期 如果start == null && end ==
	 * null,则返回yesterday 如果start after end,则返回yesterday
	 * 
	 * @param start
	 * @param end
	 * @return
