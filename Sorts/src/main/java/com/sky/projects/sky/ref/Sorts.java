...
public final class Sorts {
	...
	public static <T> void sort(Collection<T> collection,
			final String fieldName, final SortType sortType) {
	 ...
	 */
	public static <T> void sort(Collection<T> collection,
			final String fieldName, final String sortType) {
		check(collection, fieldName);
	 ...
	 *            升序：ASC，降序：DESC
	 */
	public static <T> void sort(List<T> list, final String fieldName,
	 ...
	 *            String
	 */
	private static <T> void common(List<T> list, final String fieldName,
			final String sortType) {
		Collections.sort(list, new Comparator<T>() {
			...
			public int compare(T o1, T o2) {
				...
				Object v2 = null;
				int result = 0;
				boolean isAsc = (sortType == null || "".equals(sortType.trim()) || "asc"
						.equalsIgnoreCase(sortType));
				try {
