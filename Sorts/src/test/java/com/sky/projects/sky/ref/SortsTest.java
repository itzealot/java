...
public class SortsTest {
	...
	{
		users.add(new User(1L, "zhangsan", "zhangsan", new Date(), 10,
				"I am zhangsan.", 2));
		users.add(new User(2L, "zhangsan2", "zhangsan2", new Date(), 12,
				"I am zhangsan.", 3));
		users.add(new User(3L, "zhangsan3", "zhangsan2", new Date(), 12,
				"I am zhangsan.", 3));
		users.add(new User(4L, "zhangsan2", "zhangsan2", new Date(), 8,
				"I am zhangsan.", 4));
		users.add(new User(5L, "zhangsan3", "zhangsan3", new Date(), 9,
				"I am zhangsan.", 2));
		users.add(new User(6L, "zhangsan4", "zhangsan4", new Date(), 6,
				"I am zhangsan.", 6));
		users.add(new User(7L, "zhangsan5", "zhangsan5", new Date(), 9,
				"I am zhangsan.", 2));
	}
