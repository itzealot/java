...
/**
 * 13. 静态代理模式.<br />
 * 13.1 意图：为其他对象提供一种代理以控制对这个对象的访问。
 * 
 * 13.2 主要解决：在直接访问对象时带来的问题，比如说：要访问的对象在远程的机器上。在面向对象系统中，有些对象由于某些原因（比如对象创建开销很大，
 * 或者某些操作需要安全控制，或者需要进程外的访问），直接访问会给使用者或者系统结构带来很多麻烦，我们可以在访问此对象时加上一个对此对象的访问层。
 * 
 * 13.3 何时使用：想在访问一个类时做一些控制。
 * 
 * 13.4 如何解决：增加中间层。
 * 
 * 13.5 关键代码：实现与被代理类组合。
 ...
 * ，猪八戒访问高翠兰的时候看不出来这个是孙悟空，所以说孙悟空是高翠兰代理类。 3、买火车票不一定在火车站买，也可以去代售点。<br />
...
public class ProxyPatternDemo {
	...
	public static void main(String[] args) {
		QueryDao dao = QueryProxy.createProxy();
