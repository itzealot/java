...
public class MementoPatternDemo {
	...
	public static void main(String[] args) {
		...
		// 当前对象的状态新建备忘录对象并保存到备忘录列表
		holder.add(originator.saveStateToMemento());
		...
		System.out.println("First saved State: " + originator.getStateFromMemento(holder.get(0)));
		System.out.println("Second saved State: " + originator.getStateFromMemento(holder.get(1)));
	}
}
