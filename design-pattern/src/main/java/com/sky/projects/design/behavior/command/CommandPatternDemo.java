...
import com.sky.projects.design.behavior.command.impl.BuyStock;
import com.sky.projects.design.behavior.command.impl.SellStock;
...
public class CommandPatternDemo {
	...
	public static void main(String[] args) {
		...
		// 命令调用者
		OrderHolder broker = new OrderHolder();
