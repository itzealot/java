...
public class XMLs {
	 ...
	 * @return
	 */
	public static OutputFormat getOutputFormat(int indentSize,
	 ...
	 */
	public static OutputFormat getOutputFormat(int indentSize,
			boolean newLineAfterDeclaration, String encoding) {
	 ...
	 * @throws IOException
	 */
	static String format(Document document) throws IOException {
		String result = "";
