...
public class TestDates {
	...
	@Test
	public void format() {
		Assert.assertNotEquals("date time format error.", "", Dates.format(new Date(), Dates.DateFormateType.DATE));
	...
	public void parse() {
		...
		Assert.assertNotEquals("date time parse error.", null,
				Dates.parse("2015-5-6 10:10:10", Dates.DateFormateType.DATETIME));
		Assert.assertNotEquals("date time parse error.", null,
				Dates.parse("20150506101010100", Dates.DateFormateType.MOST_DATETIME));
	}
